...
/**
 * CustomerProduceRq<p/>Request Message for Customer Production<p/>
 *
 * @version 1.0
 * @author Dominic Trumpfheller, PRODYNA AG, 2011-01-18
 */
public class CustomerProduceRq extends ServiceMessageSupport implements ServiceMessage {
    ...
    /** The master object of the new produced customer (when null a new master object is created). */
    private OrganizationMaster master;

    /** The amount of customers to produce. */
    private Number amount;

    /** Constructs a new CustomerProduceRq instance. */
    public CustomerProduceRq() {
        super();
        this.initDefaults();
    }
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(CustomerProduceRq.getPropertyDescriptor(MASTER), this.getMaster()));
        properties.add(super.createProperty(CustomerProduceRq.getPropertyDescriptor(AMOUNT), this.amount));
        return properties;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final CustomerProduceRq other = ((CustomerProduceRq) obj);
        if ((this.master == null)) {
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(CustomerProduceRq.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(CustomerProduceRq.class).getAllProperties();
    }
}
