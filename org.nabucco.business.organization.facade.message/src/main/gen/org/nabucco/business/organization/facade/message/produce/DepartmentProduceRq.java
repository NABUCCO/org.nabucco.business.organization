...
/**
 * DepartmentProduceRq<p/>Request Message for Department Production<p/>
 *
 * @version 1.0
 * @author Dominic Trumpfheller, PRODYNA AG, 2011-01-18
 */
public class DepartmentProduceRq extends ServiceMessageSupport implements ServiceMessage {
    ...
    /** The master object of the new produced department (when null a new master object is created). */
    private OrganizationMaster master;

    /** The amount of departments to produce. */
    private Number amount;

    /** Constructs a new DepartmentProduceRq instance. */
    public DepartmentProduceRq() {
        super();
        this.initDefaults();
    }
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(DepartmentProduceRq.getPropertyDescriptor(MASTER), this.getMaster()));
        properties.add(super.createProperty(DepartmentProduceRq.getPropertyDescriptor(AMOUNT), this.amount));
        return properties;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final DepartmentProduceRq other = ((DepartmentProduceRq) obj);
        if ((this.master == null)) {
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(DepartmentProduceRq.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(DepartmentProduceRq.class).getAllProperties();
    }
}
