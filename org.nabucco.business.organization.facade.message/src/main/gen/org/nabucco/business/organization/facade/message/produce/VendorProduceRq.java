...
/**
 * VendorProduceRq<p/>Default message for Vendor datatype<p/>
 *
 * @version 1.0
 * @author Dominic Trumpfheller, PRODYNA AG, 2011-01-18
 */
public class VendorProduceRq extends ServiceMessageSupport implements ServiceMessage {
    ...
    /** Constructs a new VendorProduceRq instance. */
    public VendorProduceRq() {
        super();
        this.initDefaults();
    }
    ...
    public Set<NabuccoProperty> getProperties() {
        ...
        properties.add(super.createProperty(VendorProduceRq.getPropertyDescriptor(NUMBER), this.number));
        return properties;
    }
    ...
    public boolean equals(Object obj) {
        ...
        final VendorProduceRq other = ((VendorProduceRq) obj);
        if ((this.number == null)) {
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(VendorProduceRq.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(VendorProduceRq.class).getAllProperties();
    }
}
