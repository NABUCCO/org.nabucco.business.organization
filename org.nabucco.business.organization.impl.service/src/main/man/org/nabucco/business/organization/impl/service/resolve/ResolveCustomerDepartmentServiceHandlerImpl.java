...
/**
 * ResolveCustomerDepartmentServiceHandlerImpl
 * 
 * @author Dominic Trumpfheller, PRODYNA AG
 */
public class ResolveCustomerDepartmentServiceHandlerImpl extends ResolveCustomerDepartmentServiceHandler {

    private static final long serialVersionUID = 1L;

    @Override
    protected CustomerMsg resolveCustomerDepartment(CustomerMsg msg) throws ResolveException {
