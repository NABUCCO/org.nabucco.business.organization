 ...
 */
public class Department extends OrganizationCharacteristic implements Datatype {

    private static final long serialVersionUID = 1L;

    private static final OrganizationCharacteristicType CHARACTERISTICTYPE_DEFAULT = OrganizationCharacteristicType.DEPARTMENT;
     ...
     * CloneObject.
     *
     * @param clone the Department.
     */
    protected void cloneObject(Department clone) {
    ...
    public static NabuccoPropertyDescriptor getPropertyDescriptor(String propertyName) {
        return PropertyCache.getInstance().retrieve(Department.class).getProperty(propertyName);
    }
    ...
    public static List<NabuccoPropertyDescriptor> getPropertyDescriptorList() {
        return PropertyCache.getInstance().retrieve(Department.class).getAllProperties();
    }
}
